...
const NavigationComponent: FC = () =>{
    const { userItems, usersNotifications, setUpdateNotificationsScreen, setUsersNotifications, numberOfNotifications, setNumberOfNotifications  } = useContext<any>(UserContext);
